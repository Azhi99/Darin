...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(9).default("7f6d4ad6", content, true)
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/products.vue?vue&type=template&id=1c63df04&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"preloader\"><div class=\"lds-ripple\"><div class=\"pl-spark-1 pl-spark-2\"></div></div></div> "),_c('HeaderArea'),_vm._ssrNode(" "),(_vm.loading)?_vm._ssrNode("<div class=\"text-center\">","</div>",[_c('v-progress-circular',{attrs:{"indeterminate":"","color":"primary"}})],1):_c('v-container',{staticStyle:{"margin-top":"150px","margin-bottom":"20px"},attrs:{"fluid":""}},[_c('v-select',{staticClass:"mt-2",attrs:{"label":"Category","dense":"","append-icon":"mdi-filter","clearable":"","items":_vm.categories,"item-text":"categoryName","item-value":"categoryID"},model:{value:(_vm.categoryID),callback:function ($$v) {_vm.categoryID=$$v},expression:"categoryID"}}),_vm._v(" "),(_vm.items.length == 0)?_c('div',{staticClass:"mx-auto py-10 text-center"},[_c('span',{staticClass:"grey--text"},[_vm._v(" No items found ")])]):_c('v-row',_vm._l((_vm.items),function(item,index){return _c('v-col',{key:index,attrs:{"cols":"12","md":"4","lg":"3","xl":"2"}},[_c('v-card',{staticClass:"text-center align-items-center justify-content-center",staticStyle:{"border-radius":"10px"},attrs:{"height":"100%","width":"100%","elevation":"4"}},[_c('v-img',{staticClass:"mx-auto",attrs:{"src":'/itemImages/' + item.image,"width":"256","height":"256","contain":""}}),_vm._v(" "),_c('h3',{staticClass:"text-center"},[_vm._v(" "+_vm._s(item.itemName)+" ")]),_vm._v(" "),_c('h5',{staticClass:"text-center mb-3"},[_vm._v(" "+_vm._s(item.price)+" $ ")])],1)],1)}),1),_vm._v(" "),_c('v-pagination',{staticClass:"mt-3",attrs:{"length":Math.ceil(_vm.numberOfItems / 16),"total-visible":7},model:{value:(_vm.page),callback:function ($$v) {_vm.page=$$v},expression:"page"}})],1),_vm._ssrNode(" "),_c('FooterArea'),_vm._ssrNode(" "),_c('Copyright'),_vm._ssrNode(" <div class=\"go-top\"><i class=\"ri-arrow-up-s-fill\"></i> <i class=\"ri-arrow-up-s-fill\"></i></div>")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/products.vue?vue&type=template&id=1c63df04&
...
var VPagination = __webpack_require__(211);
...
installComponents_default()(component, {HeaderArea: __webpack_require__(123).default,FooterArea: __webpack_require__(124).default,Copyright: __webpack_require__(160).default})
...
installComponents_default()(component, {VCard: VCard["a" /* default */],VCol: VCol["a" /* default */],VContainer: VContainer["a" /* default */],VImg: VImg["a" /* default */],VPagination: VPagination_VPagination,VProgressCircular: VProgressCircular["a" /* default */],VRow: VRow["a" /* default */],VSelect: VSelect["a" /* default */]})
